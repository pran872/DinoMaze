...
public class Player : MonoBehaviour
{
    ...
    void MovePlayerKeys() 
    {
        try
        {
            ...
            //clamping the input values
            translation = Mathf.Clamp(translation, -1, 1);
        ...
        {
            Debug.LogError("An error occurred in Input Manager: " + e.Message);
        }
        catch (NullReferenceException e) 
        {
            Debug.LogError("An error occurred in DinoAnimator: " + e.Message);
        }
        
        catch (ArgumentOutOfRangeException e) 
        {
            Debug.LogError("An error occurred in input values: " + e.Message);
        }
    }
